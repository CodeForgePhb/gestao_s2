...
CREATE TABLE `cursos_concluidos` (
  ...
  KEY `cursos_concluidos_ibfk_3` (`docente`),
  CONSTRAINT `cursos_concluidos_ibfk_1` FOREIGN KEY (`id_curso`) REFERENCES `curso` (`id`),
  CONSTRAINT `cursos_concluidos_ibfk_2` FOREIGN KEY (`nome_curso`) REFERENCES `curso` (`nome`),
  CONSTRAINT `cursos_concluidos_ibfk_3` FOREIGN KEY (`docente`) REFERENCES `docente` (`nome`) ON DELETE CASCADE
